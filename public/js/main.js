 ...
 $("#appointment").on("submit", function() {
     $.ajax({
         url: '/api/appointment',
         method: 'post',
         dataType: 'json',
         ...
         success: function(responce, textStatus, jqXHR) {
             ...
             // $('#response').html(responce.massage);
             var errors = responce.message;
             var errorsHtml = '';
             errorsHtml += '<ul class="list-group"><li class="list-group-item alert alert-info">' + errors + '</li></ul>';

             let form_height = $( "#appointment" ).height();
             $('#appointment').trigger("reset");
             $('#message_appointment').height(form_height);
                          $('#message_appointment').show().html(errorsHtml);
             $('#appointment').remove();
         ...
         error: function(data) {
             ...
             $('#errors_appointment').show().html(errorsHtml);
         }
     });
     return false;
 });

$("#btn_save_response").on("click", function() {
$.ajax({
         url: '/api/response',
         method: 'post',
         dataType: 'json',
         ...
         success: function(responce, textStatus, jqXHR) {
             ...
             console.log(responce.message);
             // $('#response').html(responce.massage);
$('#div_add_response').html(responce.message);
         ...
         error: function(data) {
             ...
             $('#errors_response').show().html(errorsHtml);
...
$("#btn_save_consult").on("click", function() {
$.ajax({
         url: '/api/consult',
         method: 'post',
         dataType: 'json',
...
$('#div_add_response').html(responce.message);
         ...
         error: function(data) {
             ...
             $('#errors_consult').show().html(errorsHtml);
